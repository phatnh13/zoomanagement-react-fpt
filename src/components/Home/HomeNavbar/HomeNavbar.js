...
function OffCanvasExample({ name, ...props }) {
  ...
  return (
    <>
      ...
      <Offcanvas style={{ backgroundColor: '#f5f0d7', height: '60%', with: "100%" }} show={show} onHide={handleClose} {...props}>
            ...
            <Col className="home-view__right col-md-4">
              <Link to="/news">
                <Button className="btn btn-success btn-news__homeview">
                  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="37" fill="currentColor" className="bi bi-newspaper" viewBox="0 1 16 16">
              ...
              <Link to="/buyingticket">
                <Button className="btn btn-secondary btn-ticket__homeview">
                  <svg width="40" height="37" viewBox="0 5 30 32" fill="none" xmlns="http://www.w3.org/2000/svg">
