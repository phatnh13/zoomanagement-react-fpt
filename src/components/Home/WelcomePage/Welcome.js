...
import { Row, Image, Button, Card } from "react-bootstrap";
...
<div style={{backgroundColor: '#8b9472'}}>
                <div className="d-flex justify-content-end">
                    <Button className="btn-view-all-price mt-5 me-5"><Link className="link-underline-opacity-0 link-underline link-light" to="/buyingticket">View all price</Link></Button>
                    </div>
                        ...
                        <Card className="view-price__card mx-5">
                            ...
                            <Card.Body>
                                ...
                                <Card.Title className="d-flex justify-content-center">
                                    <Button className="view-price__btn-direct-ticket link-underline-opacity-0 link-underline link-light">Book Now</Button>
                                </Card.Title>
                            </Card.Body>
                        </Card>
                        <Card className="view-price__card mx-5">
                            ...
                            <Card.Body>
                                ...
                                <Card.Title className="d-flex justify-content-center">
                                    <Button className="view-price__btn-direct-ticket link-underline-opacity-0 link-underline link-light">Purchase</Button>
                                </Card.Title>
                            </Card.Body>
                        </Card>
                    </Row>
