...
function OffCanvasExample({ name, ...props }) {
  ...
  return (
      <>
          <Button className="btn-ticket__menu me-5 btn btn-light" variant="primary" onClick={handleShow}>
  ...
  return (
    <>
      ...
      <div className="home-view__top navbar-fixed-top">
        <Link to="/news">
          <Button className="btn-news__homeview btn btn-success">
        ...
        <Link to="/buyingticket">
          <Button className="btn-ticket__homeview btn btn-warning">
